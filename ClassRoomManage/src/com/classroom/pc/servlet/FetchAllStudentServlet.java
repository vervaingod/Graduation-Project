...
/**
 * Servlet implementation class FetchAllpeopleServlet
 */
@WebServlet("/FetchAllStudentServlet")
public class FetchAllStudentServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		List<PeopleBean> peopleBeanList = peopleBiz.fetchAllStudentList();
		request.setAttribute("peopleBeanList", peopleBeanList);
		request.getRequestDispatcher("searchstudent.jsp").forward(request,
				response);
	}
