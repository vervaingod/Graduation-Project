...
/**
 * Servlet implementation class FetchFreeClassroomServlet
 */
@WebServlet("/FetchFreeClassroomServlet")
public class FetchFreeClassroomServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public FetchFreeClassroomServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		List<ClassroomBean> classroomBeanlist = classroomBiz
				.fetchFreeClassroom();
		sendObject(classroomBeanlist, response);
	}
