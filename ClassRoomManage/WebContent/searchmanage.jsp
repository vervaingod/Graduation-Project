...
<body>
	...
	<div class="page-body">
		...
		<div class="page-content">
			<div class="content-nav">人员管理 > 管理员管理</div>
			<%
					...
					<table class="formtable">
						<tr>
							...
							<td><input type="radio" id="status" name="status" value="1"
								checked="checked" /><label>已启用</label> <input type="radio"
								id="status" name="status" value="0" /><label>已停用</label>
							</td>
						</tr>
						<tr>
			...
			<table class="listtable">
				...
				<tr>
					...
					<td><%int role=peopleBean.getRole();
					String showrole="";
					if(role==0){
						showrole="学生";
					}else{
